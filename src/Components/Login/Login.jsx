        ...
        <div className={cl.wrap}>
            <div className={cl.container + " " + cl["login-register__container"]}>
                <form className={cl.form} onSubmit={handleSubmit}>
                    <h1 className={cl.header}>Авторизация</h1>
                    ...
                    <button type="submit" className={cl["form__btn"]}>Войти</button>
                    {/* <Link 
                ...
                <p className={`text ${cl.text}`}>У вас нет аккаунта? <b><CommonLink to="/register">Зарегистрируйтесь</CommonLink></b></p>
